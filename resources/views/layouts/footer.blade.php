...
<div class="page-footer">
    <div class="container"> {{ date('Y') }} &copy; 4Impact By
        <a target="_blank" href="http://aboutme.vn/machine">Machine</a> &nbsp;|&nbsp;
        <span>Toools for social listening and data visualization</span>
    </div>
</div>
